...
def main() -> None:
    ...
    gas_100_mile_cost_values: list[tuple[str, Decimal]] = get_gas_100_mile_cost_values()
    ...
    for efficiency_label, cost_per_100_miles in gas_100_mile_cost_values:
        logging.debug('%s: $%.2f per 100 miles', efficiency_label, cost_per_100_miles)
